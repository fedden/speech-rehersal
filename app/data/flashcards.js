...
So, with a heavy heart, let us begin…`
  },
  {
    ...
    front: "Competing with me",
    back: `The most annoying thing about being Alex's best friend is that he is always competing with you.`
  },
  {
    id: 5,
    title: "Cocktail Bar Story",
    front: "Manager story",
    back: `* When we were 18, I got him a job at a cocktail bar where I worked.
...
Moving forwards, the years advance. Unfortunately, Alex's mental age didn't…`
  },
  {
    id: 8,
    title: "Covid Setup",
    front: "Living together",
    back: `During the Covid pandemic, Alex lived with me and my partner in London.
...
The thing about living with Alex, is that he tends to walk quite flat footed:`
  ...
  {
    id: 10,
    title: "Footsteps Story",
    front: "New footsteps",
    back: `At 2 AM, I was used to hearing the sound: 'DOOF. DOOF. DOOF.'
...
Alex had tricked someone into liking him.`
  ...
  {
    id: 11,
    title: "Alexandra Intro",
    front: "Not just anyone",
...
To abbreviate decades, I've wasted his time, patience, money – and much else - yet to Alex's credit, he's always relaxed and is ready to go again.`
  },
  {
    id: 15,
    title: "Alex's Nature",
    front: "Force of nature",
    back: `Alex is a true force of nature. Nothing gets him down - unless arsenal loses - and he's always been so confident and collected with everyone we meet.`
  },
  {
    id: 16,
    title: "Final Truth",
    front: "Separate paths",
